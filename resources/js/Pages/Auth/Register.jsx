            ...
            <div className='w-full flex flex-col items-center justify-center content-center'>
                ...
                <form role="form" onSubmit={submitHandler} noValidate className='flex z-10 flex-col items-center justify-center content-center p-[1.3em] py-10 bg-secondary rounded-lg w-[90%] mb-10 shadow-none sm:shadow-lg sm:w-[30em]'>
                    ...
                    <div className="form-control w-full mb-2 max-w-xs flex flex-col " >
                        <h2 className='text-main text-2xl font-bold'>Let's start your special experience!</h2>
                    ...
                    <div className="form-control w-full max-w-xs lg:space-x-4 space-x-0 flex lg:flex-row flex-col">
                        ...
                        <div className="form-control w-full lg:w-1/2 max-w-xs" >
                            ...
                            <input value={data.name} onChange={changeHandler} name='name' id='name' type="text" placeholder="aden lall" className="input input-primary input-bordered w-full max-w-xs" />
                            <label className="label">
                        ...
                        <div className="form-control w-full lg:w-1/2 max-w-xs">
                            <label className="label">
                                <span className="label-text">Chose some userName</span>
                            </label>
                            <input value={data.username} onChange={changeHandler} name='username' id='username' type="text" placeholder="aden_lall" className="input input-primary input-bordered w-full max-w-xs" />
                            <label className="label">
                    ...
                    <div className="form-control w-full max-w-xs">
                        <label className="label">
                            <span className="label-text">Tipe your email</span>
                        </label>
                        <input value={data.email} onChange={changeHandler} type="email" name='email' id='email' placeholder="adenlall@example.com" className="input input-primary input-bordered w-full max-w-xs" />
                        <label className="label">
                    ...
                    <div className="form-control w-full max-w-xs">
                        ...
                        <input value={data.password} onChange={changeHandler} type="password" name='password' id='password' placeholder="*******" className="input input-primary input-bordered w-full max-w-xs" />
                        <label className="label">
                    ...
                    <div className="form-control w-full max-w-xs mt-2">
                        <div className='text-main text-sm italic'>Already have an account, <Link className='text-accent hover:text-main' href={route('login')} >Login</Link> now!</div>
                    </div>
