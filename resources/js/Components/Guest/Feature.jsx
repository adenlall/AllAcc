        ...
        <div className="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
            <div className="max-w-xl mb-10 md:mx-auto sm:text-center lg:max-w-2xl md:mb-12">
                <p className="text-base text-gray-700 md:text-lg">
                    Enjoy <span className="font-bold text-ap1">AllAcc</span> features and still always you can contribute in bulding more features on our open source project on <a target={'_blank'} href="https://github.com/adenlall/AllAcc" className="text-ago">Github</a>
                </p>
            </div>
            <div className="grid gap-8 row-gap-8 lg:grid-cols-3">
                <div className="sm:text-center">
                    ...
                    <h6 className="mb-2 font-semibold leading-5 text-black">Follow all trafics</h6>
                ...
                <div className="sm:text-center">
                    ...
                    <h6 className="mb-2 font-semibold leading-5 text-black">Clean UI</h6>
                    <p className="max-w-md mb-3 text-sm text-gray-900 sm:mx-auto">
                ...
                <div className="sm:text-center">
                    ...
                    <h6 className="mb-2 font-semibold leading-5 text-black">Free & Open source</h6>
                    <p className="max-w-md mb-3 text-sm text-gray-900 sm:mx-auto">
                        Enjoy all our services 100% free, open source & no ads & no tracking..., the sky is the limit.
                    </p>
                </div>
            </div>
        </div>
