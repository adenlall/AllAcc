                    ...
                    <div className="dropdown">
                        ...
                        <ul tabIndex="0" className="menu menu-compact dropdown-content mt-3 p-2 shadow bg-base-100 rounded-box w-52">
                            ...
                            {auth.user !== null
                                ...
                                <>
                                    <li><Link className={pageName === 'About' ? 'font-bold text-lg bg-accent rounded-xl text-black' : 'text-drk'} href="/about" >About</Link></li>
                                    <li><Link className={pageName === 'Login' ? 'font-bold text-lg bg-accent rounded-xl text-black' : 'text-drk'}  href={route('login')} >Login</Link></li>
                                    <li><Link className={pageName === 'Register' ? 'font-bold text-lg bg-accent rounded-xl text-black' : 'text-drk'}  href={route('register')} >Register</Link></li>
                                </>
                            }
                        </ul>
                    </div>
